...
## References
- `src/lib/activity_main.py` — IClassSEActivity stub at line 7997
- `src/lib/actmain.py` — activity registry
- `src/lib/actstack.py` — comments reference `server_iclassse.so` external module
- `src/middleware/gadget_linux.py` — USB gadget management
- `src/main/main.py` — startup sequence, device node cleanup
